...
INSERT INTO common_wealth_games VALUES(2, 'Hockey', 12, 'Africa', 50, 'Ronwen williams', 8, 6, 'fan', 'Africa', 3, 12, 12, 'Africa', 'India', 'India','Albert', 'Africa', 'Team Africa', 'Africa', 'National');
INSERT INTO common_wealth_games VALUES(3, 'throwball', 13, 'Bengalur bulls', 55, 'Pavan', 11, 7, 'vimal', 'Delhi', 2, 9, 13, 'Bengalur bulls', 'Tamil talivas', 'Benagur bulls','Ranveer sharma', 'Brezil', 'Bengalur bulls', 'Tamil talivas', 'International');
...
INSERT INTO common_wealth_games VALUES(7, 'Netball ', 17, 'Indaia', 85, 'Alladdin', 3, 11, 'stag', 'Alistan', 7, 14, 14, 'Pakistan', 'South-korea', 'Pakistan','Muskan', 'Turki', 'team Pakistan', 'Pakistan', 'International');
...
INSERT INTO common_wealth_games VALUES(9, 'football', 19, 'odisha', 63, 'Rehan', 12, 14, 'cococola', 'Levana', 9, 5, 15, 'Maleshia', 'West-indies', 'West-indies','Crister', 'Jermany', 'team west-indies', 'West-indies', 'National');
...
INSERT INTO common_wealth_games VALUES(11, 'Basketball', 21, 'West-Indies', 47, 'Krona', 19, 4, 'king fisher', 'Stadan', 11, 3, 17, 'West-indies', 'England', 'England','Ghockberk', 'Italy', 'team England', 'England', 'International');
INSERT INTO common_wealth_games VALUES(12, 'Swimming', 22, 'South-Korea', 95, 'Le min ho', 20, 19, 'karishma', 'Bhagthan', 12, 19, 18, 'South-korea', 'Bhutan', 'Bhutan','Felix', 'Spain', 'team Bhutan', 'Bhutan', 'National');
INSERT INTO common_wealth_games VALUES(13, 'khokho', 23, 'South-Africa', 23, 'Yanosh', 18, 18, 'lenovo', 'Swtart', 13, 29, 29, 'South-africa', 'USA', 'USA','Cris', 'Greece', 'team USA', 'USA', 'International');
...
INSERT INTO common_wealth_games VALUES(15, 'Canoeing', 25, 'japan', 40, 'fazlam', 44, 71, 'sayalee', 'fatima', 55, 45, 16, 'England', 'France', 'France','Henry', 'Holand', 'team Holand ', 'Korea', 'National');
...
SELECT lpad('fazlam', 10, 'AA');
SELECT lpad('shubham', 8, 'AA');
SELECT lpad('akshay', 3, 'AA');
SELECT lpad('manu', 5, 'AA');
SELECT lpad('maga', 14, 'AA');

/* rpad */
SELECT rpad('fazlam', 10, 'AA');
SELECT rpad('shubham', 15, 'AA');
SELECT rpad('akshay', 9, 'AA');
SELECT rpad('manu', 2, 'AA');
SELECT rpad('maga', 6, 'AA');
